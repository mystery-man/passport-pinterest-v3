**INFO**: Cloned from [Passport-pinterest](https://travis-ci.org/analog-nico/passport-pinterest) and upgraded the apis to pinterest v3.

# Passport-Pinterest-v3
...
[![NPM Stats](https://nodei.co/npm/passport-pinterest-v3.png?downloads=true)](https://npmjs.org/package/passport-pinterest-v3)

This is a module for node.js and is installed via npm:

``` bash
npm install passport-pinterest-v3 --save
```
